 ...
 * Rust serde uses {"type":"Variant","data":{...}} for payload variants.
 */
@Serializable
sealed class Message {
    ...
    data class PairRequest(val data: PairRequestData) : Message()
    ...
    @Serializable
    @SerialName("PairChallenge")
    data class PairChallenge(val data: PairChallengeData) : Message()

    @Serializable
    data class PairChallengeData(
        val device_id: String,
        val fingerprint: String,
    ...
    @Serializable
    @SerialName("PairConfirm")
    data class PairConfirm(val data: PairConfirmData) : Message()
    ...
    @Serializable
    @SerialName("PairResult")
    data class PairResult(val data: PairResultData) : Message()

    @Serializable
    data class PairResultData(
        val device_id: String,
        val trusted: Boolean,
        val message: String,
    ) : MessageData
    ...
    @Serializable
    data class PhoneBluetoothStatusData(
        val hfp_calls_toggle_enabled: Boolean,
    ) : MessageData
    ...
    @Serializable
    data class PcBluetoothStatusData(
        val hfp_supported: HfpSupport,
    ) : MessageData
    ...
    @Serializable
    data class ErrorData(val message: String) : MessageData
}

/** Marker used only to keep payload data classes grouped in this file. */
